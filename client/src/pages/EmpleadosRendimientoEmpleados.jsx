...
export default function EmpleadosRendimiento() {
            ...
            try {
                ...
                if (data && data.empleados) {
                    ...
                    const calcularPromedio = (filtro) => {
                        ...
                        const suma = filtrados.reduce((acc, cur) => acc + (cur.rendimiento_futuro_predicho || 0), 0);
    ...
    return (
        <div className="p-6 bg-gray-100 min-h-screen">
            <h2 className="text-2xl font-bold mb-4 text-black">Rendimiento Futuro de Empleados</h2>

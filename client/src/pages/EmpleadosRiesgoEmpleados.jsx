...
export default function EmpleadosRiesgo() {
    ...
    return (
        <div className="p-6 bg-gray-100 min-h-screen">
            <h2 className="text-2xl font-bold mb-4 text-black">Riesgos y Rendimiento de Empleados</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 bg-white p-4 rounded-lg shadow-md mb-6">
                        <div className="bg-white p-4 rounded-lg shadow-md">
                            ...
                            <p className="text-xs text-center text-gray-500 mb-2">
                                Muestra cuántos empleados tienen alto, medio o bajo rendimiento según el modelo.
                            </p>
                        ...
                        <div className="bg-white p-4 rounded-lg shadow-md">
                            ...
                            <p className="text-xs text-center text-gray-500 mb-2">
                                Indica el riesgo de que los empleados roten de puesto o área.
                            </p>
                            <ResponsiveContainer width="100%" height={250}>
                                <PieChart>
                        ...
                        <div className="bg-white p-4 rounded-lg shadow-md">
                            ...
                            <p className="text-xs text-center text-gray-500 mb-2">
                                Indica el riesgo de que los empleados sean despedidos.
                            </p>
                            <ResponsiveContainer width="100%" height={250}>
                                <PieChart>
                        ...
                        <div className="bg-white p-4 rounded-lg shadow-md">
                            ...
                            <p className="text-xs text-center text-gray-500 mb-2">
                                Indica el riesgo de que los empleados renuncien voluntariamente.
                            </p>
                            <ResponsiveContainer width="100%" height={250}>
                                <PieChart>

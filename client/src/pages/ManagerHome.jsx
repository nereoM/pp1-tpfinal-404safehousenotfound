...
import { User, List, PlusCircle, BarChart2, FileText, LogOut, TrendingUp, Repeat, CalendarCheck } from "lucide-react";
        ...
        <div className="min-h-screen w-full bg-blue-100 flex flex-col items-center justify-center p-4">
            <div className="w-full max-w-4xl bg-white shadow-xl rounded-2xl p-6 sm:p-8 md:p-10 space-y-6 overflow-y-auto">
                ...
                <p className="text-gray-700 text-base sm:text-lg text-center">
                    Tu Rol es Manager de Recursos Humanos. Este es tu panel de administración. Aquí podrás acceder a todas las herramientas necesarias para gestionar los procesos de RRHH.
                </p>
                ...
                <div className="grid grid-cols-1 gap-4 w-full mt-6">
                    ...
                    <div className="flex items-center gap-4 p-4 bg-emerald-100 rounded-lg shadow-md cursor-pointer hover:bg-emerald-200 transition w-full">
                        <TrendingUp className="text-emerald-600 w-6 h-6" />
                        <span className="text-gray-800 text-base sm:text-lg">Evaluar desempeño del personal</span>
                    </div>

                    {/* Análisis de Rotación */}
                    <div className="flex items-center gap-4 p-4 bg-orange-100 rounded-lg shadow-md cursor-pointer hover:bg-orange-200 transition w-full">
                        <Repeat className="text-orange-600 w-6 h-6" />
                        <span className="text-gray-800 text-base sm:text-lg">Ver análisis de rotación</span>
                    </div>

                    {/* Análisis de Licencias */}
                    <div className="flex items-center gap-4 p-4 bg-blue-100 rounded-lg shadow-md cursor-pointer hover:bg-blue-200 transition w-full">
                        <CalendarCheck className="text-blue-600 w-6 h-6" />
                        <span className="text-gray-800 text-base sm:text-lg">Consultar uso de licencias</span>
                    </div>

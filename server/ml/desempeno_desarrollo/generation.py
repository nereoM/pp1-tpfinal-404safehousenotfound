from .dataset_generator import generate_employee_dataset, add_future_performance, add_risks, generar_dataset_postulaciones, agregar_riesgo_rotacion
...
def main():
    ...
    df, _ = generar_dataset_postulaciones(400)

    df_con_riesgo = agregar_riesgo_rotacion(df)
...
# if __name__ == "__main__":
    ...
    # df, _ = generar_dataset_postulaciones(100)
